...
const CLROStageLevelSummary = (props) => {
  ...
  return (
    <View id='dynamic-height'>
      ...
      <View style={[membraneStyle.textHeader, { marginTop: 15 }]} bookmark={{ title: `${serialNum}.${subSerialNum} CLRO Flow Summary (Element Level) ` }} >
                ...
                {(() => {
                  ...
                  return (
                    <View style={[membraneStyle.mainTable, { marginTop: 10 }]}>
                      ...
                      {/* <View style={[membraneStyle.tableRow]}> */}
