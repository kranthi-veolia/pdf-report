    ...
    >
      ...
      >
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{fontFamily:ChineseFonts}}>{(version && version.project_name) || 'Project Name'}</Text>
        </View>
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ width: RationValWidth(100) }}>File Name</Text>
          <Text style={{fontFamily:ChineseFonts}}>{(version && version.file_name) || 'File Name'}</Text>
        </View>
      </View>
