...
const Invoice = (props) => {
  ...
  const filterOptions = (SectionName)=>{
    ...
    if(filterValues[0].disabled === false || filterValues[0].checked === false ){return false;}return true;
  };
  return (
    <Document>
      ...
      {invoiceData && Object.keys(invoiceData.cf_summary).length && filterOptions('CF Unitop Summary') && (
        <Page size='A4' style={styles.page} bookmark={`${serialNum}. CF Unitop Summary`}>
          <HeaderSection version={invoiceData.project_details} />
          <View style={styles.body}>
            <DisplayCF
      ...
      {invoiceData && invoiceData.erd_summary && Object.keys(invoiceData.erd_summary).length > 0 && filterOptions('ERD Unitop Summary (WIP)') && (
        <Page size='A4' style={styles.page} bookmark={`${serialNum}. ERD Unitop Summary (WIP)`}>
          <HeaderSection version={invoiceData.project_details} />
          <View style={styles.body}>
            <DisplayERD
      ...
      {/* Pumps Unitop Summary */}
      {invoiceData && invoiceData.pump_summary && Object.keys(invoiceData.pump_summary).length > 0 && filterOptions('Pump Unitop Summary') &&(
        <Page size='A4' style={styles.page} bookmark={`${serialNum}. Pump Unitop Summary`}>
          <HeaderSection version={invoiceData.project_details} />
          <View style={styles.body}>
            <DisplayPump
      ...
      {invoiceData && invoiceData.stripper_summary && Object.keys(invoiceData.stripper_summary).length > 0 && filterOptions('Stripper Unitop Summary') && (
        <Page size='A4' object-fit='fill' style={styles.page} bookmark={`${serialNum}. Stripper Unitop Summary`}>
          <HeaderSection version={invoiceData.project_details} />
          <View style={styles.body}>
            <DisplayStripper
      ...
      {invoiceData && invoiceData.mixer_summary && Object.keys(invoiceData.mixer_summary).length > 0 && filterOptions('Mixer-Splitter Unitop Summary') &&(
        <Page size='A4' object-fit='fill' style={styles.page} bookmark={`${serialNum}. Mixer-Splitter Unitop Summary`}>
          <HeaderSection version={invoiceData.project_details} />
          <View style={styles.body}>
            <MixerSplitter
