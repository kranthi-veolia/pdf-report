  ...
  return (
    <View>
      ...
      <View style={Styles.mainHeader}>
        <Text style={[Styles.mainHeaderText, { paddingRight: 5 }]}>{serialNum}. Pump Summary</Text>
        <SubLine lineWidth='80%' lineHeight='24' />
      </View>
          ...
          return (
            <View key={ind} break={ind > 1} style={[Styles.table, { marginTop: 10, width: (195 + ((values.length - 1) * 70)) }]}>
              ...
              <View style={[Styles.tableRow, { borderTopWidth: 0.5, borderColor: '#B3D3D7' }]}>
                <Text style={Styles.tableCellTextHeader} >Total Pump Consumption (kW) = {pumps['Total Pump Consumption (kW)'].toFixed(2)}</Text>
              </View>
            </View>
          );
        })}
