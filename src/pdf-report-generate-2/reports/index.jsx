  ...
  return (
    <View>
      ...
      <View style={Styles.mainHeader}>
        ...
        <SubLine lineWidth='75%' lineHeight='24' />
      </View>
      {(() => {
        ...
        return (
          <View style={[Styles.table, { width: 540 }]}>
            {/* 1st Rows ---> Kranthi */}
                      ...
                      return (unique_unitop[0].data.map((text, u_i) => {
                        return (
                          <View key={u_i} style={Styles.tableRow}>
                            {/* 2nd coloumn ---> Kranthi */}
                            <View style={[Styles.tableRCText, { width: C2Width }]}>
                            ...
                            {/* 3rd coloumn ---> Kranthi */}
                            <View style={[Styles.tableRCText, { width: C3Width, paddingLeft: 10, alignItems: 'left' }]}>
                              <Text style={Styles.tableCell}>{text.split('\n')[0]}</Text>
                            </View>
                          </View>
                        );
                      }));
