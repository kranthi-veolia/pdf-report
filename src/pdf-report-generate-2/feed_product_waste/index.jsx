    ...
    <View>
      ...
      </View>
      {
        ...
        multiple_steams.map((values, ind) => {
          return (
            <View key={ind} break={ind > 0} style={[Styles.table, { marginTop: 15, width: (227 + ((values.length - 2) * 52)) }]}>
                                ...
                                return (
                                  <View style={Styles.tableRow} key={i}>
                                    <View style={[
                                      ...
                                      { paddingLeft: 10, alignItems: 'left', width: 105 }
                                    ]}>
                                      <Text style={Styles.tableCell}>{subkey.key}</Text>
                                    </View>
                                    <View style={[
                                      Styles.tableRCText,
                                      (Main_heading.includes(`${k_i}-${i}`)) && { borderBottom: 1, borderBottomColor: '#818B8D' },
                                      ...
                                      return (
                                        <View key={h_i} style={[
                                          ...
                                          {(() => {
                                            ...
                                            if (subkey.keyVal === 'Information') {
                                              return (<Text style={Styles.tableCell}>{feed_product_waste[val][keys.key]}</Text>);
                                            }
                                            if (subkey.key === 'TDS') {
