          ...
          <View key={ind} break={ind > 1} style={[Styles.table, { marginTop: 10, width: (195 + ((values.length - 1) * 70)), borderWidth: 1, borderColor }]}>
            ...
            <View style={Styles.tableRow}>
              ...
              {values.map((val, i) => {
                return (
                  <View key={i} style={[
                    Styles.tableHeader, { width: C3Width, borderTop: 1, borderBottom: 1, borderRight: 1, borderRightColor: borderColor, borderTopColor: borderColor, borderBottomColor: borderColor },
            ...
            {key_value.map((keys, k_i) => {
              return (
                <View style={[Styles.tableRow]} key={k_i}>
                  <View style={[
                    Styles.tableRCText,
                    { borderBottom: 1, borderBottomColor: borderColor, paddingLeft: 10, alignItems: 'left', width: 125 },
                  ...
                  {/*   units of Unitop ID  */}
                  <View style={[
                    Styles.tableRCText, { borderBottom: 1, borderBottomColor: borderColor, width: C3Width },
                    k_i === key_value.length - 1 && { borderBottom: 0 }
                  ]}>
