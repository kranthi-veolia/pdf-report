...
export const ArgoinvoiceData = {
  'Selected Product': 'Hypersperse MDC775',
  'Required Dosage': '2.18 mg/l',
  'Plant Data': {
    'Designed By': '',
    'Plant Name': '',
    'Water Source': '',
    'Recovery': 75,
    'Recommended Dose of Hypersperse MDC775': '2.18 mg/l',
    'Feed pH': 7.5,
    'Feed Temperature': 25
  },
  'Water Quality Data': {
  ...
  'Calculation Results': {
    'Saturation': {
      'CaCO3': -0.594056483268217,
      'CaSO4': 0.12370863980597127,
      'BaSO4': 0,
      'SrSO4': 0.001210916057035928,
      'CaF2': 0.00035872623557320555,
      'Fe': 0.19781745590402589,
      'Mn': 0,
      'Al': 0,
      'SiO2': 0.08373648616595566,
      'CCPP': 0,
      'CaHPO4': 8.889514565193892,
      'LowCCPP': 0
    },
    'Limits': {
      'CaCO3': 1000,
    ...
    '% of Max': {
      'CaCO3': -0.05940564832682171,
      'CaSO4': 2.9454438049040776,
      'BaSO4': 0,
      'SrSO4': 0.0034597601629597946,
      'CaF2': 0.0000027594325813323504,
      'Fe': 28.259636557717986,
      'Mn': 0,
      'Al': 0,
      'SiO2': 0.06699186860750883,
      'CCPP': 0,
      'CaHPO4': 74.07928804328243,
      'LowCCPP': 0
    }
  },
  'Degrees of Saturation': {
    'No Inhibitor': {
      ...
      'Mn': 0,
      'Al': 0,
      'SiO2': 8.373648616595567,
      'CaHPO4': 120,
      'LowCCPP': 0
    },
    'With Hypersperse MDC775': {
      'CaCO3': 0,
      'CaSO4': 2.9454438049040776,
      'BaSO4': 0,
      'SrSO4': 0.0034597601629597946,
  ...
  report_dict: {
    coverpage_dict: {
      project_info: {
        ...
        phone: '',
        notes:
          '上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开上面的 链接 我打不开',
      },
      spec_flow: {
        type: 'Feed_1',
        flow_rate: '600.0 gpm',
      ...
      flow_bal: {
        'unit id (stream no.)': {
          '0': '-',
          incoming_feeds: ['Feed_1 (1)'],
          product: ['Product_1 (11)'],
          waste: ['Waste_1 (16)', 'Waste_2 (14)', 'Waste_3 (15)'],
        },
        flow: {
          '0': 'gpm',
          incoming_feeds: [600],
          product: [176.4294966785078],
          waste: [416.39351975321324, 2.800012328067487, 4.578996495306529],
        },
        'flow-total': {
          '0': 'gpm',
          incoming_feeds: 600,
    ...
    feed_product_waste_summary: {
      ...
      'Unit ID': ['Feed_1', 'Waste_1', 'Product_1', 'Waste_2', 'Waste_3'],
    },
    edi_summary: {
      system_summary: {
        units: {
    ...
    pump_summary: {
      ...
      'Pump Unit ID': ['HP_Pump_1', 'HP_Pump_2', 'HP_Pump_3'],
      pump_nos: 3,
    },
    chem_dose_summary: {
      units: {
      ...
      'Chemical Dosing Unit ID': ['Chem_Dose_1', 'Chem_Dose_2'],
      agg_chem_dose_dict: {
        'Sulfuric Acid - 96%': {
    ...
    erd_summary: {
      units: {
        ...
        'RO Unit Attached': '-',
        'Installed Location': '-',
        'LP Discharge Pressure': 'kPa',
        'Net Transfer Efficiency': '%',
        'Boost Pressure': 'kPa',
        'Power Saving': 'kW',
        'Leakage (Reject in HP OUT)': '%',
      ...
      PW_1: {
        'ERD Type': 'Pelton Wheel',
        'RO Unit Attached': 'RO_PW_1',
        'Installed Location': 'In front of 1st Stage',
        'LP Discharge Pressure': 205.68974999999995,
        'Net Transfer Efficiency': 53.400000000000006,
        'Boost Pressure': '-',
        'Power Saving': 1871.128036919391,
        'Leakage (Reject in HP OUT)': '-',
        'Mixing at Membrane Feed': '-',
        'Circulation Pump': '-',
        'HP Pump': 5691.814000316133,
        'Energy Recovered': 1620.2474308967546,
        'Total Power Consumption': 4241.215176478519,
      },
      'ERD Unit ID': ['PW_1'],
      erd_nos: 1,
    },
    ro_summary: {
      ro_system_dict: {
        ...
        ro_nos: 3,
        'RO Unit ID': ['RO-HP_1', 'RO-HP_2', 'RO-HP_3'],
      },
      ro_stage_dict: {
        'RO-HP_1': {
          Stage: {
