...
import { RationValWidth, ArialRegural, ArialB600, ChineseFonts } from '../fonts/font';
    ...
    >
      ...
      >
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ fontFamily: ChineseFonts, fontSize: RationValWidth(12) }}>{(version && version.project_name) || 'Project Name'}</Text>
        </View>
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ width: RationValWidth(100), fontSize: RationValWidth(16), fontFamily: ArialB600 }}>File Name</Text>
          <Text style={{ fontFamily: ChineseFonts, fontSize: RationValWidth(12) }}>{(version && version.file_name) || 'File Name'}</Text>
        </View>
      </View>
