...
function Table1(props) {
  ...
  const key_value = [
    ...
    { 'key': 'Electrode Bleed Flow', 'KeyText': 'Electrode Bleed Flow' },
    { 'key': 'EDI Unit Recovery', 'KeyText': 'EDI Unit Recovery' },
    // { 'key': 'Flow Per EDI Stack', 'KeyText': 'Flow Per EDI Stack' },
    { 'key': 'Number of E-Cell EDI Stack', 'KeyText': 'No. of E-Cell EDI Stacks' },
    { 'key': 'Feed Temperature', 'KeyText': 'Feed Temperature' },
    { 'key': 'Feed Pressure', 'KeyText': 'Feed Pressure' },
    { 'key': 'Concentrate Pressure', 'KeyText': 'Concentrate Pressure' },
    { 'key': 'Product Outlet Pressure', 'KeyText': 'Product Outlet Pressure' },
    { 'key': 'Current', 'KeyText': 'Current' },
    { 'key': 'Voltage', 'KeyText': 'Voltage' },
    { 'key': 'AC Power', 'KeyText': 'AC Power' },
    { 'key': 'Co-Current Flow', 'KeyText': 'Co-Current Flow' },
    { 'key': 'Feed TDS', 'KeyText': 'Feed TDS' },
    { 'key': 'Feed pH', 'KeyText': 'Feed pH' },
    { 'key': 'Product Resistivity', 'KeyText': 'Product Resistivity' },
    { 'key': 'Product pH', 'KeyText': 'Product pH' },
    { 'key': 'Concentrate TDS', 'KeyText': 'Concentrate TDS' },
    { 'key': 'Concentrate pH', 'KeyText': 'Concentrate pH' },
    { 'key': 'Electrode Bleed TDS', 'KeyText': 'Electrode Bleed TDS' },
    { 'key': 'Electrode Bleed pH', 'KeyText': 'Electrode Bleed pH' }];
  const sub_heading = ['0-0', '0-6', '0-18', '0-20', '0-22']; // where we need sub heading boarder ---> Kranthi
  const Main_heading = ['0-1', '0-7', '0-12', '0-15', '0-16']; // where we need Main heading boarder ---> Kranthi
  return (
    <View>
